...
setuptools.setup(name='cloud-init',
      ...
      license='GPLv3',
      data_files=[('/opt/freeware/etc/cloud', glob('config/*.cfg')),
                  ('/opt/freeware/etc/cloud/cloud.cfg.d', glob('config/cloud.cfg.d/*')),
                  ('/opt/freeware/etc/cloud/templates', glob('templates/*')),
                  ('/opt/freeware/share/cloud-init', []),
                  ('/opt/freeware/lib/cloud-init',
                    ['tools/uncloud-init',
                     'tools/write-ssh-key-fingerprints']),
                  ('/opt/freeware/share/doc/cloud-init',
                   [f for f in glob('doc/*') if is_f(f)]),
                  ('/opt/freeware/share/doc/cloud-init/examples',
                   [f for f in glob('doc/examples/*') if is_f(f)]),
                  ('/opt/freeware/share/doc/cloud-init/examples/seed',
